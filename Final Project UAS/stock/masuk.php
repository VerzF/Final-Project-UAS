...
if (isset($_POST['update'])) {
    ...
    if ($jumlah >= $qtyskrg) {
        ...
        $updatedata1 = mysqli_query($conn, "update sbrg_masuk set tgl='$tanggal',jumlah='$jumlah',pemasok='$pemasok' ,keterangan='$keterangan' where id='$id'");
        ...
        $updatedata = mysqli_query($conn, "update sbrg_masuk set tgl='$tanggal', jumlah='$jumlah', pemasok='$pemasok' keterangan='$keterangan' where id='$id'");
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table id="dataTable3" class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                $brg = mysqli_query($conn, "SELECT * from sbrg_masuk sb, sstock_brg st where st.idx=sb.idx order by sb.tgl DESC");
                                                $no = 1;
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><button data-toggle="modal" data-target="#edit<?= $idb; ?>" class="btn btn-warning"><i class="fa-solid fa-pen-to-square" style="color: #ffffff;"></i></button> <button data-toggle="modal" data-target="#del<?= $idb; ?>" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></button></td>
                                                    </tr>
                                                            ...
                                                            <div class="modal-content">
                                                                <form method="post">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <input type="text" id="pemasok" name="pemasok" class="form-control" value="<?php echo $b['pemasok'] ?>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="barang_masuk_act.php" method="post">
                        ...
                        <div class="form-group">
                            <label>Pemasok</label>
                            <input name="pemasok" type="text" class="form-control" placeholder="Pemasok" required>
                        </div>
                        <div class="form-group">
