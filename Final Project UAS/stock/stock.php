                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $brgs = mysqli_query($conn, "SELECT * from sstock_brg");
                                            $no = 1;
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="d-flex"><button data-toggle="modal" data-target="#edit<?= $idb; ?>" class="btn btn-warning"><i class="fa-solid fa-pen-to-square" style="color: #ffffff;"></i></button> <button data-toggle="modal" data-target="#del<?= $idb; ?>" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></button></td>
                                                </tr>
                    ...
                    <form action="tmb_brg_act.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="satuan" class="custom-select form-control" required>
                                ...
                                <option value="Buah">gram</option>
                                <option value="Unit">kilogram</option>
                                <option value="Meter">ml</option>
                                <option value="Milimeter">liter</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Lokasi</label>
