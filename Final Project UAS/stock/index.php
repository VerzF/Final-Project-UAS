...
<body>
                ...
                <div class="row no-gutters align-items-center h-100">
                  <div class="col mr-2">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                      <?php
                      $brg_masuk = mysqli_query($conn, "SELECT jumlah FROM sbrg_masuk where tgl = date(sysdate());");
                      $jumlah_masuk = 0;
                      while ($p_masuk = mysqli_fetch_array($brg_masuk)) {
                        $jumlah_masuk = $jumlah_masuk + $p_masuk['jumlah'];
                      }
                      echo $jumlah_masuk;
                      ?>
                    </div>
              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center h-100">
                  <div class="col mr-2">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                      <?php
                      $brg_keluar = mysqli_query($conn, "SELECT jumlah FROM sbrg_keluar where tgl = date(sysdate());");
                      $jumlah_keluar = 0;
                      while ($p_keluar = mysqli_fetch_array($brg_keluar)) {
                        $jumlah_keluar = $jumlah_keluar + $p_keluar['jumlah'];
                      }
                      echo $jumlah_keluar;
                      ?></div>
                  </div>
          ...
          <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
              ...
              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold">Stock In/Out Overview</h6>
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                ...
                <div class="mt-4 text-center small">
                  <span class="mr-2" style="font-family: Nunito;">
  ...
  <script>
    ...
    var myBarChart = new Chart(ctx, {
      ...
      data: {
        <?php
        $query = mysqli_query($conn, "SELECT MONTH(tgl) AS bulan, SUM(jumlah) AS masuk FROM sbrg_masuk GROUP BY MONTH(tgl);");
        while ($data = $query->fetch_array()) {
          $nomor_bulan = $data['bulan'];
          $nama_bulan = date("M", mktime(0, 0, 0, $nomor_bulan, 1));
          $masuk[] = $data['masuk'];
          $bulan[] = $nama_bulan;
        }
        ?>
        ...
        datasets: [{
          ...
          },
          {
            ...
            hoverBackgroundColor: "#d63026",
            borderColor: "#e74a3b",
            <?php
            $query = mysqli_query($conn, "SELECT MONTH(tgl) AS bulan, SUM(jumlah) AS keluar FROM sbrg_keluar GROUP BY MONTH(tgl);");
            while ($data = $query->fetch_array()) {
              $keluar[] = $data['keluar'];
            }
            ?>
