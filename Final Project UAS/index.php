...
if (isset($_POST['submit'])) {
    ...
    if (isset($_POST['remember'])) {
        // Simpan nilai username dan password dalam cookie
...
// Periksa apakah cookie username dan password ada
if (isset($_COOKIE['username']) && isset($_COOKIE['password'])) {
    // Isi nilai input form dengan nilai cookie
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="autentikasi.php">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user <?php echo ($error_username != "" ? "is-invalid" : ""); ?>" name="username" id="username" aria-describedby="usernameHelp" placeholder="Username" value="<?php echo $username; ?>" required>
                                            <span class="invalid-feedback"><?php echo $error_username; ?></span>
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user <?php echo ($error_password != "" ? "is-invalid" : ""); ?>" name="password" id="password" placeholder="Password" value="<?php echo $password; ?>" required>
                                            <span class="invalid-feedback"><?php echo $error_password; ?></span>
                                        </div>
                                        <p class="text-center">username & password : admin</p>
                                        <div class="form-group">
